...
class TournamentManagement(BaseView):
    ...
    def load_tournaments(self):
        ...
        try:
            ...
            query = db.query(
                ...
                TournamentType, Tournament.tournament_typesId == TournamentType.id
            ).outerjoin(
        ...
        def save():
            try:
                ...
                tournament = Tournament(
                    tournamentName=name_var.get(),
                    gameId=game.id,
                    tournament_typesId=tournament_type.id,
    ...
    def edit_tournament(self):
        ...
        try:
            ...
            types = self.get_tournament_types()
            type_var = tk.StringVar()
            current_type = next(t for t in types if t.id == tournament.tournament_typesId)
            ...
            def save_changes():
                try:
                    ...
                    tournament.tournament_typesId = tournament_type.id
